...
const EventFormat = () => {
  ...
  return (
    <section id="event-format" className="py-20 relative bg-gradient-to-br from-teal-200 via-blue-200 to-purple-200">
      <div className="container mx-auto px-4">
        ...
        <div className="flex flex-col lg:flex-row gap-10">
          ...
          >
            <div className="p-6 bg-white/20 backdrop-blur-3xl rounded-lg border border-white/20 shadow-2xl transition-all hover:border-purple-500 hover:shadow-xl">
              <div className="mb-6">
              ...
              <div className="mb-6">
                ...
                <div className="flex flex-col space-y-4">
                  <div className="p-4 bg-gray-50 rounded-lg border border-gray-200 shadow-2xl">
          ...
          <motion.div
            ...
            transition={{ duration: 0.6 }}
          >
            <div className="p-6 bg-white/20 backdrop-blur-lg rounded-lg border border-white/20 shadow-2xl transition-all hover:border-teal-500 hover:shadow-md">
              <div className="mb-6">
                <div className="flex items-center mb-4">
